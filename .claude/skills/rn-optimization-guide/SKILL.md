---
name: rn-optimization-guide
description: This skill should be used when the user asks questions about React Native optimization, performance tuning, TTI (Time to Interactive), FPS (Frames Per Second), memory leaks in React Native, bundling optimization, React Native profiling, or mentions topics from "The Ultimate Guide to React Native Optimization (2026)". Also use when the conversation starts and the user wants to learn from the React Native optimization book in this repository.
tools: Read, Bash, Grep
---

# React Native Optimization Guide

This skill helps users learn from **"The Ultimate Guide to React Native Optimization (2026)"** by Callstack - a comprehensive learning resource for React Native developers covering performance optimization across JavaScript, native, and bundling layers.
